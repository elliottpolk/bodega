...
// new Product records in the datastore
func Create(ctx context.Context, items []*Product, db *mongo.Database) error {
	...
	for i, item := range items {
		...
		// ensure the Product has an unique identifier
		if len(item.Id) < 1 {
...
// RetrieveOne ...
func RetrieveOne(ctx context.Context, id string, db *mongo.Database) (*Product, error) {
...
// Retrieve ...
func Retrieve(ctx context.Context, filter bson.D, db *mongo.Database) ([]*Product, error) {
...
// Update ...
func Update(ctx context.Context, user string, filter bson.D, items []*Product, db *mongo.Database) error {
